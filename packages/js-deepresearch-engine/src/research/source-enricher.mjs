...
async function enrichOneSource(source, {
  ...
  if (fetched.status !== 'ok' || fetched.evidenceRole === 'metadata') {
    return {
      ...
      retrievedAt: fetched.retrievedAt || null,
      sourceUrl: fetched.sourceUrl || source.sourceUrl || null,
      contentSha256: fetched.contentSha256 || null,
      cacheHit: fetched.cacheHit === true,
      manualImportPath: fetched.manualImportPath || source.manualImportPath || null,
  ...
  const fetchedSource = {
    ...
    sourceUrl: fetched.sourceUrl || source.sourceUrl || fetched.finalUrl || source.url,
    contentSha256: fetched.contentSha256 || null,
    cacheHit: fetched.cacheHit === true,
    manualImportPath: fetched.manualImportPath || source.manualImportPath || null,
