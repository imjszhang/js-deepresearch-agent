      ...
      <form id="research-form" class="card">
        ...
        <div id="exploratoryFields" class="grid strategy-panel">
          ...
          <div>
            ...
            <input id="exploratoryMinTokens" type="number" min="0" value="${exploratory.minLlmTokens ?? exploratory.targetLlmTokens ?? 600000}" />
          </div>
          <div>
            <label for="exploratoryMaxTokens">Max LLM tokens (0 = unlimited)</label>
            <input id="exploratoryMaxTokens" type="number" min="0" value="${exploratory.maxLlmTokens ?? 1000000}" />
          </div>
          <div>
